...
namespace Opencart\Admin\Controller\Extension\VodaPay\Report;

use Opencart\System\Engine\Controller;

class VodaPay extends Controller
{
    public const REPORT_EXTENSION_LITERAL = "extension/vodapay/report/vodapay";
    ...
    protected function getList()
    {
        ...
        $order_total = $this->model_extension_vodapay_report_vodapay->getTotalOrders($filter_data);
        $results     = $this->model_extension_vodapay_report_vodapay->getOrders($filter_data);
        ...
        $data['order_statuses'] = $this->model_extension_vodapay_report_vodapay->getVodaPayOrderSatuts();
        ...
        $this->response->setOutput($this->load->view('extension/report/vodapay_order_list', $data));
    }
}
